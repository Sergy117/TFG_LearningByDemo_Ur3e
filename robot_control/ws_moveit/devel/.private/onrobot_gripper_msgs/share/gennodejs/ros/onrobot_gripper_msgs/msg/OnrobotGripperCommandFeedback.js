...
class OnrobotGripperCommandFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new OnrobotGripperCommandFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnrobotGripperCommandFeedback(null);
...
module.exports = OnrobotGripperCommandFeedback;
