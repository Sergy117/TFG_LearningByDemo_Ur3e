...
let OnrobotGripperCommandFeedback = require('./OnrobotGripperCommandFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class OnrobotGripperCommandActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new OnrobotGripperCommandFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = OnrobotGripperCommandFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new OnrobotGripperCommandActionFeedback(null);
    ...
    data.feedback = OnrobotGripperCommandFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new OnrobotGripperCommandActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = OnrobotGripperCommandFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new OnrobotGripperCommandFeedback()
    }
...
module.exports = OnrobotGripperCommandActionFeedback;
